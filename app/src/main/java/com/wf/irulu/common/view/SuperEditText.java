...
/**
 * @描述: 扩展EditText（带清除、卡号、电话号码格式输入框）
 * @项目名: irulu1.2
 * @包名:com.wf.irulu.common.view
 * @类名:SuperEditText
 * @作者: 左杰
 * @创建时间:2015/11/17 18:51
 */
public class SuperEditText extends EditText implements View.OnFocusChangeListener {
    /**
     * 删除按钮的引用
     */
...
//            mClearDrawable = getResources().getDrawable(R.drawable.delete_selector);
            mClearDrawable = getResources().getDrawable(R.mipmap.delete_sign_in_icon);
        }
    ...
    TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            mListener.onAfterTextChanged(s);
        }
    };
