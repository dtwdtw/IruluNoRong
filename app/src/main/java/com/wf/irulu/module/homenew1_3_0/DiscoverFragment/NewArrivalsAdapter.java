 ...
 */
public class NewArrivalsAdapter extends RecyclerView.Adapter<NewArrivalsAdapter.HomeRecyclerHolder>{
    ...
    public NewArrivalsAdapter(Context context, List<ProductInfo> productListBea, IruluController controller){
...
//        this.width = (ConstantsUtils.DISPLAYW - UIUtils.dip2px(20)) / 2;
    ...
    public HomeRecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.item_grid_newarrivals, parent, false);
