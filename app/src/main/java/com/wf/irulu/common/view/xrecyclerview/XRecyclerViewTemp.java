...
/**
 *  在xRecyclerView 的基础上加入emptyView
 */
public class XRecyclerViewTemp extends RecyclerView {
    ...
    public XRecyclerViewTemp(Context context) {
        this(context, null);
    }

    public XRecyclerViewTemp(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XRecyclerViewTemp(Context context, AttributeSet attrs, int defStyle) {
...
//        mFootViews.get(0).setVisibility(GONE);
        LoadingMoreFooter footView = (LoadingMoreFooter) mFootViews.get(0);
        footView.mText.setVisibility(GONE);
    }
    ...
    public void showRefreshHeader() {
        ...
        mRefreshHeader.setState(mRefreshHeader.STATE_REFRESHING);
    }
