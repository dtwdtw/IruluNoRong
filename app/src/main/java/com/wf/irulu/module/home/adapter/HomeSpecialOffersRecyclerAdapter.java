 ...
 */
public class HomeSpecialOffersRecyclerAdapter extends RecyclerView.Adapter<HomeSpecialOffersRecyclerAdapter.HomeRecyclerHolder>{
    ...
    public HomeSpecialOffersRecyclerAdapter(Context context, ArrayList<ProductInfo> productList, IruluController controller){
