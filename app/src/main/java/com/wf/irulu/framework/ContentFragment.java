 ...
 */
public class ContentFragment extends BaseFragment implements OnClickListener, ServiceListener, ShoppingCartCountListener, NoInternetConnListener {
...
//        mTabStrip.setTabBackground(getResources().getColor(R.color.transparent));//取消点击Tab时的背景色，这里在xml中设置了
    ...
    public void serviceSuccess(ActionTypes action, Object bandObj, Object returnObj) {
        ...
        mHomeProductList = homeList.getList();setAdapter();
    }
    ...
    class MainFragmentPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public int getItemPosition(Object object) {
            return mHomeProductList==null?POSITION_NONE:mHomeProductList.indexOf(object);
        }
