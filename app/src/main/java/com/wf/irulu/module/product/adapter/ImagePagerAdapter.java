...
//			url = url + "?imageMogr2/auto-orient/thumbnail/!75p";
            RequestCreator requestCreator = mPicasso.load(url).error(R.mipmap.bg_picutre_show).placeholder(R.mipmap.bg_picutre_show);       //.memoryPolicy(MemoryPolicy.NO_CACHE,MemoryPolicy.NO_STORE)
            requestCreator.noFade();
            requestCreator.into(loadView, new Callback() {
                @Override
                public void onSuccess() {
