...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView(Context context) {
        ...
        mArrowImageView.setBackgroundResource(R.drawable.animation);
        ...
        mArrowAnim = (TranslateAnimation) AnimationUtils.loadAnimation(getContext(), R.anim.translateanimation);

        mArrowAnim.setAnimationListener(new Animation.AnimationListener() {
            @Override
...
//            mProgressBar.setView(new ProgressBar(mContext, null, android.R.attr.progressBarStyle));
    ...
    public void setState(int state) {
        ...
        } else if (state == STATE_RELEASE_TO_REFRESH) {    // 显示箭头图片
            mArrowImageView.clearAnimation();
