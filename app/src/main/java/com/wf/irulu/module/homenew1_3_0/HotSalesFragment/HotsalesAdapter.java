 ...
 */
public class HotsalesAdapter extends RecyclerView.Adapter<HotsalesAdapter.HomeRecyclerHolder>{
    ...
    public HotsalesAdapter(Context context, List<ProductInfo> productList, IruluController controller){
...
//        holder.product_comment_num.setText(commentNum);
        ...
        holder.product_old_price.setText(StringUtils.getPriceByFormat(Float.parseFloat(productInfo.getPrice())));
        holder.product_old_price.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG | Paint.ANTI_ALIAS_FLAG);
        holder.flag.setText(productInfo.getPercent()+"%\nOFF");
    ...
    public class HomeRecyclerHolder extends RecyclerView.ViewHolder {
        private TextView product_new_price,product_old_price,flag;
        private ImageView image,wishlist_icon_iv;
//        private RatingBar product_star;
        private View mView;
