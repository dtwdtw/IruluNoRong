 ...
 */
public class RecommendAdapter extends RecyclerView.Adapter<RecommendAdapter.HomeRecyclerHolder>{
    ...
    public RecommendAdapter(Context context, List<ProductInfo> productListBea, IruluController controller){
...
//        this.width = (ConstantsUtils.DISPLAYW - UIUtils.dip2px(20)) / 2;
    ...
    public HomeRecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.item_grid_recommend, parent, false);
...
//        holder.wishlist_icon_iv.setOnClickListener(new AddWishlistOnClick(mContext, holder.wishlist_icon_iv, productInfo, controller));
         ...
         */
        if(percent.equals("0")){
            holder.product_old_price.setVisibility(View.GONE);
            holder.biaoqian_tv.setVisibility(View.GONE);
        }
