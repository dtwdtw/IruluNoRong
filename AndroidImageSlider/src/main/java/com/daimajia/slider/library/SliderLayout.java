...
public class SliderLayout extends RelativeLayout{
    ...
    public void setConfigs(Picasso picasso, BaseSliderView.ScaleType scaleType, int errorResId, int emptyRedId, boolean isNeedCache, SliderAdapter.OnSliderClickListener listener) {
        mSliderAdapter.setConfigs(picasso, scaleType, errorResId, emptyRedId, isNeedCache, listener);
    }

    public void setUrls(List<String> urls) {
        mSliderAdapter.setUrls(urls);
    }
